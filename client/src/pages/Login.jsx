...
import { Sun, Moon, Monitor, Eye, EyeOff, Lock, Mail, Cloud, AlertCircle, ArrowRight } from 'lucide-react';
    ...
    <div style={styles.container}>
      ...
      <div style={styles.cardContainer} className="glass card glow">
        ...
        <div style={styles.header}>
          ...
          <h2 style={styles.title}>Welcome back to</h2>
          <h1 style={styles.brand}>CloudVault</h1>
          <p style={styles.subtitle}>Secure, high-performance S3 storage with smart deduplication.</p>
        </div>
